[![Java CI with Gradle](https://github.com/Katkutia/Selenide/actions/workflows/gradle.yml/badge.svg)](https://github.com/Katkutia/Selenide/actions/workflows/gradle.yml)
